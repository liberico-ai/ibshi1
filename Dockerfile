...
ARG GIT_SHA=unknown
ARG BUILD_TIME=
ARG NEXT_PUBLIC_FF_BOM_CASCADE=true
ARG NEXT_PUBLIC_FF_REVISE_FLOW=false
ENV GIT_SHA=$GIT_SHA
ENV BUILD_TIME=$BUILD_TIME
ENV NEXT_PUBLIC_FF_BOM_CASCADE=$NEXT_PUBLIC_FF_BOM_CASCADE
ENV NEXT_PUBLIC_FF_REVISE_FLOW=$NEXT_PUBLIC_FF_REVISE_FLOW
