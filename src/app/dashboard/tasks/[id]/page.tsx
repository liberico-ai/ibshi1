...
import LsxWbsPanel from '@/components/LsxWbsPanel'
import type { TeamAssign, CellAssignMap, LsxIssuedMap, MaterialReqMap, MomItem, MomSection, MomAttendant, SupplierQuote, SupplierEntry, PrevStepFile, WbsRow } from '@/lib/types'
import { formatCurrency, formatDate, formatDateTime, formatNumber } from '@/lib/utils'
import { notify, confirmDialog } from '@/components/ui/Toast'
import WbsTableUI from './components/WbsTableUI'
...
// MomSectionsUI extracted to @/components/MomSectionsUI.tsx
            ...
            {(task.stepCode === 'P3.3' || task.stepCode === 'P3.4') && previousStepData?.plan?.wbsItems && (
              <div style={{ width: '100%', marginTop: '1rem' }}>
                <LsxWbsPanel
                  ...
                  wbsItems={(previousStepData.plan as Record<string, unknown>).wbsItems}
                  initialResultData={formData as Record<string, unknown>}
                  editable={isActive}
                />
              </div>
            )}
