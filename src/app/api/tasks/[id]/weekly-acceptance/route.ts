...
export async function POST(request: Request, context: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    // ══════════════════════════════════════════════════════════════
    //  Khối AUTO-TRIGGER P5.1.1 đã GỠ (2026-08): hạng mục đạt 100% không còn tự sinh
    //  "Yêu cầu nghiệm thu chất lượng" riêng — chất lượng nghiệm thu cùng khối lượng ở màn ITP.
    // ══════════════════════════════════════════════════════════════
