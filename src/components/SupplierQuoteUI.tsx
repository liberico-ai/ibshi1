...
export default function SupplierQuoteUI({ taskId, isEditable, bomPrData, value, onChange }: Props) {
  ...
  return (
    <div className="space-y-4">
      {/* A: PR Reference */}
      {Array.isArray(prItems) && prItems.length > 0 && (
        <div className="rounded-xl p-4" style={{ background: '#f0f9ff', border: '1px solid #bae6fd' }}>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-xs">
              ...
              <tbody>
                {prItems.slice(0, 50).map((item: Record<string, unknown>, i: number) => (
          ...
          {prItems.length > 50 && <div className="text-xs mt-1" style={{ color: '#64748b' }}>... và {prItems.length - 50} dòng nữa</div>}
        </div>
      )}
        ...
        <div key={q.id} className="rounded-xl p-4" style={{
          ...
          <div className="grid gap-3" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))' }}>
            ...
            <div>
              ...
              {isEditable ? (
                ...
                <div className="text-sm">{q.vendorName || '—'} {q.vendorCode && <span className="text-xs" style={{ color: '#64748b' }}>({q.vendorCode})</span>}</div>
              )}
            </div>

            <div>
              <label className="text-xs font-semibold" style={{ color: 'var(--text-muted)' }}>Ngày báo giá</label>
              <input type="date" value={q.quoteDate} disabled={!isEditable}
            ...
            <div>
              ...
              <div className="flex gap-1">
                <input type="number" value={q.totalAmount || ''} disabled={!isEditable}
                ...
                <select value={q.currency} disabled={!isEditable}
            ...
            <div>
              ...
              <input type="number" value={q.leadTimeDays || ''} disabled={!isEditable}
            ...
            <div>
              ...
              <input type="text" value={q.paymentTerms} disabled={!isEditable}
            ...
            <div>
              ...
              <input type="text" value={q.note} disabled={!isEditable}
          ...
          {q.selected && (
            <div className="mt-3">
              ...
              <input type="text" value={q.selectReason} disabled={!isEditable}
