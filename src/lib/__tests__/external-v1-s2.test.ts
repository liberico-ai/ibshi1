...
describe('DEPARTMENTS_V2', () => {
  it('has 16 departments (cơ cấu rút gọn 5/2026: 5 xưởng + SITEMGR)', () => {
    expect(DEPARTMENTS_V2).toHaveLength(16)
  })
  ...
  it('maps to expected deptCode/displayLabel shape', () => {
    ...
    expect(mapped[15]).toEqual({ deptCode: 'SITEMGR', displayLabel: 'Site Manager' })
  })
})
