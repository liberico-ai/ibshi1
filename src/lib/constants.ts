...
export const MENU_ITEMS = [
  ...
  // ── Warehouse ──
  { key: 'warehouse', label: 'Kho', labelEn: 'Warehouse', icon: 'Package', href: '/dashboard/warehouse', roles: 'all', group: 'warehouse' },
  ...
  { key: 'kiem-tra-ton-kho', label: 'Kiểm tra tồn kho', labelEn: 'Stock Check', icon: 'SearchCheck', href: '/dashboard/warehouse/kiem-tra-ton-kho', roles: ['R01', 'R02', 'R03', 'R03a', 'R05', 'R05a', 'R07', 'R07a', 'R10'], group: 'warehouse' },
  ...
  { key: 'anh-xa-vat-tu', label: 'Ánh xạ vật tư APL', labelEn: 'APL Material Mapping', icon: 'ArrowLeftRight', href: '/dashboard/warehouse/anh-xa-vat-tu', roles: ['R01', 'R03', 'R03a', 'R04', 'R04a', 'R05', 'R05a', 'R10'], group: 'warehouse' },
  ...
  { key: 'doi-soat', label: 'Đối soát mua sắm', labelEn: 'Reconciliation', icon: 'AlertTriangle', href: '/dashboard/warehouse/doi-soat', roles: ['R01', 'R02', 'R03', 'R07', 'R07a', 'R08', 'R08a', 'R10'], group: 'warehouse' },
  ...
  // Khoán theo xưởng: R06b (tổ trưởng) được thêm riêng ở ĐÂY, các mục báo cáo khác giữ nguyên.
  { key: 'khoan-theo-xuong', label: 'Khoán theo xưởng', labelEn: 'Piece Rate by Workshop', icon: 'Hammer', href: '/dashboard/reports/khoan-theo-xuong', roles: ['R01', 'R02', 'R02a', 'R03', 'R03a', 'R06', 'R06a', 'R06b', 'R08', 'R08a', 'R10'], group: 'reports' },
...
//  P2-đợt2 hé lộ workshops + fat-sat (đã rà lại: 2 trang hoạt động đầy đủ, API /api/workshops + /api/qc có sẵn)]
