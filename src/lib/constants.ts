...
export const ROLES = {
  ...
  R02a: { code: 'R02a', name: 'Phó PM', nameEn: 'Deputy PM' },
  R03: { code: 'R03', name: 'Kinh tế Kế hoạch', nameEn: 'Planning & Economics' },
  R03a: { code: 'R03a', name: 'Phó KT-KH', nameEn: 'Deputy Planning' },
  ...
  R06b: { code: 'R06b', name: 'Tổ trưởng SX', nameEn: 'Team Leader' },
  ...
  R09a: { code: 'R09a', name: 'Inspector', nameEn: 'Inspector' },
...
export const PRODUCT_TYPES = [
  ...
  { value: 'hrsg_fgd', label: 'HRSG & FGD Systems', labelEn: 'HRSG & FGD Systems' },
  ...
  { value: 'petrochemical', label: 'Petrochemical Skid & Module', labelEn: 'Petrochemical Skid & Module' },
] as const
...
export const MENU_ITEMS = [
  // ── Overview ──
  { key: 'dashboard', label: 'Dashboard', labelEn: 'Dashboard', icon: 'LayoutDashboard', href: '/dashboard', roles: 'all', group: 'overview' },
  ...
  { key: 'lessons', label: 'Bài học KN', labelEn: 'Lessons', icon: 'BookOpen', href: '/dashboard/lessons', roles: ['R01', 'R02', 'R02a'], group: 'project' },
  ...
  { key: 'bom', label: 'BOM', labelEn: 'BOM', icon: 'Layers', href: '/dashboard/design/bom', roles: ['R01', 'R04', 'R04a', 'R02', 'R02a'], group: 'design' },
  ...
  { key: 'eco', label: 'ECO', labelEn: 'ECO', icon: 'RefreshCw', href: '/dashboard/design/eco', roles: ['R01', 'R04', 'R04a', 'R02', 'R02a', 'R06'], group: 'design' },
  ...
  { key: 'purchase-requests', label: 'Đề nghị MH', labelEn: 'PR', icon: 'FileInput', href: '/dashboard/warehouse/purchase-requests', roles: ['R01', 'R02', 'R02a', 'R03', 'R03a', 'R05', 'R05a', 'R07', 'R07a'], group: 'warehouse' },
  { key: 'purchase-orders', label: 'Đơn ĐH', labelEn: 'PO', icon: 'FileOutput', href: '/dashboard/warehouse/purchase-orders', roles: ['R01', 'R02', 'R02a', 'R03', 'R03a', 'R05', 'R05a', 'R07', 'R07a'], group: 'warehouse' },
  ...
  { key: 'material-issue', label: 'Cấp phát VT', labelEn: 'Mat Issue', icon: 'PackageMinus', href: '/dashboard/warehouse/material-issue', roles: ['R01', 'R05', 'R05a', 'R06', 'R06a'], group: 'warehouse' },
  ...
  { key: 'jobcards', label: 'Phiếu CV', labelEn: 'Job Cards', icon: 'Clipboard', href: '/dashboard/production/job-cards', roles: ['R01', 'R06', 'R06a', 'R06b'], group: 'production' },
  ...
  { key: 'itp', label: 'ITP', labelEn: 'ITP', icon: 'FileCheck', href: '/dashboard/qc/itp', roles: ['R01', 'R09', 'R09a'], group: 'qc' },
  { key: 'ncr', label: 'NCR', labelEn: 'NCR', icon: 'AlertTriangle', href: '/dashboard/qc/ncr', roles: ['R01', 'R09', 'R09a', 'R06', 'R06a'], group: 'qc' },
  ...
  { key: 'mill-certs', label: 'MTR', labelEn: 'Mill Certs', icon: 'FileText', href: '/dashboard/qc/mill-certificates', roles: ['R01', 'R09', 'R09a'], group: 'qc' },
  { key: 'fat-sat', label: 'FAT/SAT', labelEn: 'FAT/SAT', icon: 'TestTube', href: '/dashboard/qc/fat-sat', roles: ['R01', 'R09', 'R09a'], group: 'qc' },
  { key: 'mrb', label: 'Hồ sơ MRB', labelEn: 'MRB Dossier', icon: 'FolderCheck', href: '/dashboard/qc/mrb', roles: ['R01', 'R09', 'R09a'], group: 'qc' },
  ...
  { key: 'contracts', label: 'Hợp đồng LĐ', labelEn: 'Contracts', icon: 'FileSignature', href: '/dashboard/hr/contracts', roles: ['R01', 'R02', 'R02a'], group: 'hr' },
  { key: 'piece-rate', label: 'HĐ Khoán', labelEn: 'Piece Rate', icon: 'Hammer', href: '/dashboard/hr/piece-rate', roles: ['R01', 'R02', 'R02a', 'R06', 'R06a'], group: 'hr' },
  { key: 'piece-rate-output', label: 'KL Khoán', labelEn: 'Output', icon: 'BarChart', href: '/dashboard/hr/piece-rate-output', roles: ['R01', 'R02', 'R02a', 'R06', 'R06a', 'R06b'], group: 'hr' },
  ...
  { key: 'admin', label: 'Admin Dashboard', labelEn: 'Admin Dashboard', icon: 'Shield', href: '/dashboard/admin', roles: ['R01', 'R10'], group: 'system' },
