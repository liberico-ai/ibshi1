...
export const MENU_ITEMS = [
  ...
  { key: 'giai-trinh-dau-thau', label: 'Giải trình MSDT', labelEn: 'Bid Justification', icon: 'FileCheck', href: '/dashboard/warehouse/giai-trinh-dau-thau', roles: ['R01', 'R03', 'R03a', 'R05', 'R05a', 'R07', 'R07a', 'R10'], group: 'warehouse' },
