...
const hookEndStr = "const isFormVisible = isActive && (!task.stepStatus || task.stepStatus === 'IN_PROGRESS')";
...
const p12End = content.indexOf("})()}", p12Start) + 5;
content = content.substring(0, p12Start) + 
  ...
  content.substring(p12End);

const p13Start = content.indexOf("{/* WBS Readonly */}");
const p13End = content.indexOf("{/* Long-lead items form */}");
content = content.substring(0, p13Start) + 
  "{/* P3.1: Unified WBS Table UI */}\n" +
  "                  <div style={{ width: '100%', marginTop: '1rem' }}>\n" +
  "                    {renderWbsTableUI(false, wbsRows)}\n" +
  "                  </div>\n\n                  " +
  content.substring(p13End);
